...
| World-model | Language Models Meet World Models |  |  |
| World-model | Learning to Model the World with Language |  |  |
| World-model | Diffusion World Model |  |  |
| World-model | Learning to Model the World with Language |  |  |
| VLM, World-model | Large World Model (LWM)01 |  |  |
...
| Text-to-Image, World-model | World Model on Million-Length Video And Language W<br>ith RingAttention |  |  |
| Survey, Video | Video Understanding with Large Language Models: A <br>Survey |  |  |
| Survey, VLM | MM-LLMs: Recent Advances in MultiModal Large Langu<br>age Models |  |  |
| Survey, Training | Understanding LLMs: A Comprehensive Overview from <br>Training to Inference |  |  |
...
| Scaling | LONGNET: Scaling Transformers to 1,000,000,000 Tok<br>ens | [ArXiv](https://arxiv.org/abs/2307.02486) | 2023/07/01 |
...
| Robot, Zero-shot | Universal Manipulation Interface: In-The-Wild Robo<br>t Teaching Without In-The-Wild Robots |  |  |
| Robot, Zero-shot | Mirage: Cross-Embodiment Zero-Shot Policy Transfer<br> with Cross-Painting |  |  |
| Robot, Zero-shot | Zero-Shot Task Generalization with Multi-Task Deep<br> Reinforcement Learning |  |  |
...
| Robot, Survey | Real-World Robot Applications of Foundation Models<br>: A Review |  |  |
| Robot | OK-Robot: What Really Matters in Integrating Open-<br>Knowledge Models for Robotics |  |  |
| Robot | RoCo: Dialectic Multi-Robot Collaboration with Lar<br>ge Language Models | [ArXiv](https://arxiv.org/abs/2307.04738) |  |
| Robot | Interactive Language: Talking to Robots in Real Ti<br>me |  |  |
| Robot | Reflexion: Language Agents with Verbal Reinforceme<br>nt Learning | [ArXiv](https://arxiv.org/abs/2303.11366) | 2023/03/20 |
| Robot | Generative Expressive Robot Behaviors using Large <br>Language Models |  |  |
| Robot | RoboCat: A Self-Improving Generalist Agent for Rob<br>otic Manipulation |  |  |
| Robot | https://www.semanticscholar.org/paper/047e3812854a<br>86b2a2e113219fa956eda860ce24 |  |  |
...
| Resource | paperswithcode | [ArXiv](https://paperswithcode.com/) |  |
| Resource | huggingface | [ArXiv](https://huggingface.co/papers) |  |
| Resource | dailyarxiv | [ArXiv](https://dailyarxiv.com/) |  |
| Resource | connectedpapers | [ArXiv](https://www.connectedpapers.com/) |  |
| Resource | semanticscholar | [ArXiv](https://www.semanticscholar.org) |  |
| Resource | AlphaSignal | [ArXiv](https://alphasignal.ai/) |  |
| Resource | https://arxiv-sanity-lite.com/ | [ArXiv](https://arxiv-sanity-lite.com/) |  |
| Reinforcement-Learning | Large Language Models Are Semi-Parametric Reinforc<br>ement Learning Agents |  |  |
| Reinforcement-Learning | RLang: A Declarative Language for Describing Parti<br>al World Knowledge to Reinforcement Learning Agents |  |  |
...
| Reasoning, Symbolic | Symbol-LLM: Leverage Language Models for Symbolic <br>System in Visual Human Activity Reasoning |  |  |
| Reasoning, Survey | Reasoning with Language Model Prompting: A Survey | [ArXiv](https://arxiv.org/abs/2212.09597) |  |
| Reasoning, Robot | AlphaBlock: Embodied Finetuning for Vision-Languag<br>e Reasoning in Robot Manipulation |  |  |
| Reasoning, Reinforcement-Learning | ReFT: Reasoning with Reinforced Fine-Tuning |  |  |
| Reasoning | NavGPT: Explicit Reasoning in Vision-and-Language <br>Navigation with Large Language Models |  |  |
...
| Reasoning | ReConcile: Round-Table Conference Improves Reasoni<br>ng via Consensus among Diverse LLMs. |  |  |
| Reasoning | Self-Discover: Large Language Models Self-Compose <br>Reasoning Structures |  |  |
...
| Reasoning | Take a Step Back: Evoking Reasoning via Abstractio<br>n in Large Language Models |  |  |
| Reasoning | STaR: Bootstrapping Reasoning With Reasoning | [ArXiv](https://arxiv.org/abs/2203.14465) | 2022/05/28 |
| Reasoning | The Impact of Reasoning Step Length on Large Langu<br>age Models |  |  |
| RLHF, Reinforcement-Learning, Survey | A Survey of Reinforcement Learning from Human Feed<br>back |  |  |
| RLHF | Secrets of RLHF in Large Language Models Part II: <br>Reward Modeling |  |  |
...
| RAG, Survey | Retrieval-Augmented Generation for Large Language <br>Models: A Survey |  |  |
...
| RAG | RAG-Fusion: a New Take on Retrieval-Augmented Gene<br>ration |  |  |
| RAG | RAFT: Adapting Language Model to Domain Specific R<br>AG |  |  |
| Quantization, Scaling | SliceGPT: Compress Large Language Models by Deleti<br>ng Rows and Columns |  |  |
| Prompting, Survey | A Systematic Survey of Prompt Engineering in Large<br> Language Models: Techniques and Applications |  |  |
...
| Perception, Reasoning, Robot | Reasoning Grasping via Multimodal Large
Language M<br>odel | [ArXiv](https://arxiv.org/abs/2402.06798) |  |
...
| Perception | DINO: DETR with Improved DeNoising Anchor Boxes fo<br>r End-to-End Object Detection |  |  |
...
| Perception | SAM-CLIP: Merging Vision Foundation Models towards<br> Semantic and Spatial Understanding |  |  |
...
| Open-source, Perception | Grounding DINO: Marrying DINO with Grounded Pre-Tr<br>aining for Open-Set Object Detection |  |  |
...
| Multimodal, Robot | Open-World Object Manipulation using Pre-trained V<br>ision-Language Models | [ArXiv](https://arxiv.org/abs/2303.00905) | 2023/03/02 |
...
| Math, Reasoning | DeepSeekMath: Pushing the Limits of Mathematical R<br>easoning in Open Language Models |  |  |
...
| Lab | OpenGVLab - https://github.com/OpenGVLab/InternGPT<br>, https://github.com/OpenGVLab/Instruct2Act |  |  |
...
| LLM, Reinforcement-Learning, Reward, Robot | Text2Reward: Automated Dense Reward Function Gener<br>ation for Reinforcement Learning |  |  |
...
| Instruction-Turning, Survey | Vision-Language Instruction Tuning: A Review and A<br>nalysis |  |  |
...
| Instruction-Turning, Survey | A Survey on Data Selection for LLM Instruction Tun<br>ing |  |  |
...
| Instruction-Turning | Self-Instruct: Aligning Language Models with Self-<br>Generated Instructions |  |  |
...
| In-Context-Learning, Scaling | Structured Prompting: Scaling In-Context Learning <br>to 1,000 Examples |  | 2020/03/06 |
| In-Context-Learning, Scaling | Rethinking the Role of Scale for In-Context Learni<br>ng: An Interpretability-based Case Study at 66 Billion Scale |  | 2022/03/06 |
| In-Context-Learning, Reinforcement-Learning | AMAGO: Scalable In-Context Reinforcement Learning <br>for Adaptive Agents |  |  |
...
| In-Context-Learning | ChatEval: Towards Better LLM-based Evaluators thro<br>ugh Multi-Agent Debate | [ArXiv](https://arxiv.org/abs/2308.07201) | 2023/08/14 |
...
| In-Context-Learning | What does CLIP know about a red circle? Visual pro<br>mpt engineering for VLMs |  |  |
| In-Context-Learning | Can large language models explore in-context? |  |  |
| Image, LLaMA, Perception | LLaMA-VID: An Image is Worth 2 Tokens in Large Lan<br>guage Models |  |  |
...
| Gym, PPO, Reinforcement-Learning, Survey | Can Language Agents Approach the Performance of RL<br>? An Empirical Study On OpenAI Gym |  |  |
| Grounding, Reinforcement-Learning | Grounding Large Language Models in Interactive Env<br>ironments with Online Reinforcement Learning |  |  |
| Grounding, Reasoning | Visually Grounded Reasoning across Languages and C<br>ultures |  |  |
...
| Foundation, LLaMA, Vision | VisionLLaMA: A Unified LLaMA Interface for Vision <br>Tasks |  |  |
...
| Feedback, Robot | Correcting Robot Plans with Natural Language Feedb<br>ack |  |  |
| Feedback, Robot | Learning to Learn Faster from Human Feedback with <br>Language Model Predictive Control |  |  |
...
| Feedback, In-Context-Learning, Robot | InCoRo: In-Context Learning for Robotics Control w<br>ith Feedback Loops |  |  |
...
| Embodied, World-model | Language Models Meet World Models:
Embodied Experi<br>ences Enhance Language Models |  |  |
...
| Embodied, Robot | Large Language Models as Generalizable Policies fo<br>r Embodied Tasks |  |  |
| Embodied, Reasoning, Robot | Natural Language as Polices: Reasoning for Coordin<br>ate-Level Embodied Control with LLMs | [ArXiv](https://arxiv.org/abs/2403.13801), [GitHub](https://github.com/shure-dev/NLaP) | 2024/03/20 |
...
| Distilling | Distilling Step-by-Step! Outperforming Larger Lang<br>uage Models with Less Training Data and Smaller Model Sizes01 |  |  |
| Diffusion, Text-to-Image | Mastering Text-to-Image Diffusion: Recaptioning, P<br>lanning, and Generating with Multimodal LLMs |  |  |
| Diffusion, Survey | On the Design Fundamentals of Diffusion Models: A <br>Survey | [ArXiv](https://arxiv.org/abs/2306.04542) |  |
| Diffusion, Speech | NaturalSpeech 3: Zero-Shot Speech Synthesis with F<br>actorized Codec and Diffusion Models |  |  |
| Diffusion, Robot | https://3d-diffusion-policy.github.io/ |  |  |
| Diffusion | A latent text-to-image diffusion model |  |  |
| Demonstration, GPT4, PersonalCitation, Robot | GPT-4V(ision) for Robotics: Multimodal Task Planni<br>ng from Human Demonstration |  |  |
...
| Context-Window, Reasoning, RoPE, Scaling | Resonance RoPE: Improving Context Length Generaliz<br>ation of Large Language Models |  |  |
| Context-Window, LoRA, Scaling, Survey | Beyond Efficiency: A Systematic Survey of
Resource<br>-Efficient Large Language Models | [ArXiv](https://arxiv.org/abs/2401.00625) |  |
...
| Context-Window, Foundation | Mamba: Linear-Time Sequence Modeling with Selectiv<br>e State Spaces |  |  |
| Context-Window | RoFormer: Enhanced Transformer with Rotary Positio<br>n Embedding |  |  |
...
| Code-as-Policies, Robot | RoboScript: Code Generation for Free-Form Manipula<br>tion Tasks across Real and Simulation |  |  |
| Code-as-Policies, Robot | Creative Robot Tool Use with Large Language Models |  |  |
| Code-as-Policies, Robot | RoboScript: Code Generation for Free-Form
Manipula<br>tion Tasks across Real and Simulation |  |  |
...
| Chain-of-Thought, Reasoning | Skeleton-of-Thought: Prompting LLMs for Efficient <br>Parallel Generation |  |  |
...
| Chain-of-Thought, Code-as-Policies | Chain of Code: Reasoning with a Language Model-Aug<br>mented Code Emulator |  |  |
...
| Brain, Conscious | Could a Large Language Model be Conscious? |  |  |
| Brain | LLM-BRAIn: AI-driven Fast Generation of Robot Beha<br>viour Tree based on Large Language Model |  |  |
...
| Benchmark, GPT4 | Sparks of Artificial General Intelligence:
Early e<br>xperiments with GPT-4 |  |  |
...
| Audio2Video, Diffusion, Generation, Video | EMO: Emote Portrait Alive - Generating Expressive <br>Portrait Videos with Audio2Video Diffusion Model under Weak Conditions |  |  |
...
| Anything, Depth | Depth Anything: Unleashing the Power of Large-Scal<br>e Unlabeled Data |  |  |
| Anything, Caption, Perception, Segmentation | Segment and Caption Anything |  |  |
| Anything, CLIP, Perception | SAM-CLIP: Merging Vision Foundation Models towards<br> Semantic and Spatial Understanding |  |  |
| Agent, Web | WebLINX: Real-World Website Navigation with Multi-<br>Turn Dialogue |  |  |
| Agent, Web | WebVoyager: Building an End-to-End Web Agent with <br>Large Multimodal Models |  |  |
...
| Agent, Tool | Gorilla: Large Language Model Connected with Massi<br>ve APIs |  |  |
| Agent, Tool | ToolLLM: Facilitating Large Language Models to Mas<br>ter 16000+ Real-world APIs |  |  |
...
| Agent, Survey | Agent AI: Surveying the Horizons of Multimodal Int<br>eraction |  |  |
...
| Agent, Soft-Dev | MetaGPT: Meta Programming for A Multi-Agent Collab<br>orative Framework |  |  |
...
| Agent, Reasoning | Pangu-Agent: A Fine-Tunable Generalist Agent with <br>Structured Reasoning |  |  |
| Agent, Reasoning | AGENT INSTRUCTS LARGE LANGUAGE MODELS TO BE GENERA<br>L ZERO-SHOT REASONERS |  |  |
...
| Agent, MobileApp | You Only Look at Screens: Multimodal Chain-of-Acti<br>on Agents | [GitHub](https://github.com/cooelf/Auto-UI) |  |
...
| Agent, Minecraft | LARP: Language-Agent Role Play for Open-World Game<br>s |  |  |
| Agent, Minecraft | Steve-Eye: Equipping LLM-based Embodied Agents wit<br>h Visual Perception in Open Worlds |  |  |
| Agent, Minecraft | S-Agents: Self-organizing Agents in Open-ended Env<br>ironment |  |  |
| Agent, Memory, RAG, Robot | RAP: Retrieval-Augmented Planning
with Contextual <br>Memory for Multimodal LLM Agents |  |  |
| Agent, Memory, RAG | RAP: Retrieval-Augmented Planning with Contextual <br>Memory for Multimodal LLM Agents | [ArXiv](https://arxiv.org/abs/2402.03610) | 2024/02/06 |
...
| Agent, LLM, Planning | LLM-Planner: Few-Shot Grounded Planning for Embodi<br>ed Agents with Large Language Models |  |  |
| Agent, Game | LEARNING EMBODIED VISION-LANGUAGE PRO- GRAMMING FR<br>OM INSTRUCTION, EXPLORATION, AND ENVIRONMENTAL FEEDBACK |  |  |
| Agent, GUI, Web | "What’s important here?": Opportunities and
Challe<br>nges of Using LLMs in Retrieving Information
from Web Interfaces |  |  |
...
| Agent, GUI | SeeClick: Harnessing GUI Grounding for Advanced Vi<br>sual GUI Agents |  |  |
| Agent, GPT4, Web | GPT-4V(ision) is a Generalist Web Agent, if Ground<br>ed |  |  |
...
| Agent, Embodied, Survey | https://www.semanticscholar.org/paper/04f87baf7d1b<br>3eb303a52a8a66c8189f396dd114 |  |  |
...
| Agent, Embodied, Robot | OPEx: A Component-Wise Analysis of LLM-Centric Age<br>nts in Embodied Instruction Following |  |  |
...
| Agent, Embodied | LLM-Planner: Few-Shot Grounded Planning for Embodi<br>ed Agents with Large Language Models |  |  |
...
| Agent | LLM-Powered Hierarchical Language Agent for Real-t<br>ime Human-AI Coordination |  |  |
...
| Agent | AutoGen: Enabling Next-Gen LLM Applications via Mu<br>lti-Agent Conversation |  |  |
| Agent | CAMEL: Communicative Agents for “Mind” Exploration<br> of Large Language Model Society |  |  |
...
| Agent | Agents: An Open-source Framework for Autonomous La<br>nguage Agents |  |  |
...
| Agent | ScreenAgent: A Vision Language Model-driven Comput<br>er Control Agent |  |  |
| Agent | AssistGPT: A General Multi-modal Assistant that ca<br>n Plan, Execute, Inspect, and Learn |  |  |
| Agent | PromptAgent: Strategic Planning with Language Mode<br>ls Enables Expert-level Prompt Optimization |  |  |
| Agent | Cognitive Architectures for Language Agents | [ArXiv](https://arxiv.org/abs/2309.02427) |  |
| Agent | Ghost in the Minecraft: Generally Capable Agents f<br>or Open-World Environments via Large Language Models with Text-based Knowledge and Memory01 |  |  |
| Action-Generation, Generation, Prompting | Prompt a Robot to Walk with Large Language Models |  |  |
| APIs, Agent, Tool | Gorilla: Large Language Model Connected with Massi<br>ve APIs |  |  |
| AGI, Survey | Levels of AGI: Operationalizing Progress on the Pa<br>th to AGI |  |  |
| AGI, Brain | When Brain-inspired AI Meets AGI |  |  |
| AGI, Brain | Divergences between Language Models and Human Brai<br>ns |  |  |
...
|  | AgentTuning: Enabling Generalized Agent Abilities <br>For LLMs |  |  |
